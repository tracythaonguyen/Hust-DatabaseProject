...
insert into sys.roles values (1, 'Staff');
insert into sys.roles values (2, 'Product Manager');
insert into sys.roles values (3, 'Sales Manager');
...
call new_account('thaobaymau', 'thao123', 3);
