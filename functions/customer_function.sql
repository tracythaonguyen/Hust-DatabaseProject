...
DROP FUNCTION IF EXISTS sales.view_customer_info(in customer_id_input bigint);
CREATE OR REPLACE FUNCTION sales.view_customer_info(in customer_id_input bigint)  
...
select * from sales.view_customer_info(1);
